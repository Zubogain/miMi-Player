import { Dispatch, ReducersMapObject, StateFromReducersMapObject, CombinedState, $CombinedState, ThunkAction, ThunkDispatch, AnyAction, createAsyncThunk } from "@reduxjs/toolkit";
...
export const asyncTrackOpenFile = () => async (dispatch: Dispatch, getState: () => any) => {
...
// export const asyncTrackToggle1 = () => {
...
export const asyncTrackPlay = () => (dispatch: Dispatch, getState: () => any) => {
...
export const asyncTrackPause = () => (dispatch: Dispatch, getState: () => any) => {
    console.log("asyncTrackPause")
    PlayerPause();
    dispatch(trackSetPause());
}

// export const asyncTrackVolumeMutedToggle1 = (muted: boolean) => (dispatch: Dispatch, getState: () => any) => {
...
export const asyncTrackSetVolume = (volume: number) => (dispatch: Dispatch, getState: () => any) => {
